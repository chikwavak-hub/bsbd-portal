  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      for (const p of parsed) {
        const generatedFlags = generateFlags(p.treatments||[], p.ins_carrier||'')
        await sbPost('collection_patients',{
          ...p, office, date,
          flags_total: generatedFlags.length,
          flags_done:  0,
      ...
      await load()
      notify('Loaded '+parsed.length+' patients from "'+sheet+'" — flags auto-generated')
